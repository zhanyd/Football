...
*/
window.UEDITOR_HOME_URL = "/Hello/scripts/ueditor/";
var URL;
...
,toolbars:[["FontFamily","FontSize","Bold","Italic","Underline","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","InsertOrderedList","InsertUnorderedList","Indent","ForeColor","BackColor","Horizontal","Link","InsertImage","Attachment","InsertTable"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'fontfamily':'','fontsize':'','bold':'','italic':'','underline':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','insertorderedlist':'','insertunorderedlist':'','indent':'','forecolor':'','backcolor':'','horizontal':'','link':'','insertimage':'','attachment':'','inserttable':''}
...
,'fontfamily':[{"label":"","name":"songti","val":"宋体,SimSun"},{"label":"","name":"kaiti","val":"楷体,楷体_GB2312, SimKai"},{"label":"","name":"heiti","val":"黑体, SimHei"},{"label":"","name":"lishu","val":"隶书, SimLi"},{"label":"","name":"arial","val":"arial, helvetica,sans-serif"},{"label":"","name":"arialBlack","val":"arial black,avant garde"}]
